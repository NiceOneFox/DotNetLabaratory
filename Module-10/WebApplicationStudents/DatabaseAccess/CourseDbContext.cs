    ...
    public class CourseDbContext : DbContext
    {
        ...
        protected override void OnModelCreating(ModelBuilder modelBuilder)
        {
            ...
            modelBuilder.Entity<LectureDb>().HasData(
                new[]
                {
                    new {Id = 1, Date = DateTime.ParseExact("11/03/2021", new string[] { "MM.dd.yyyy", "MM-dd-yyyy", "MM/dd/yyyy" }, provider, DateTimeStyles.None), Name = "Docker", HomeworkId = 1, LectorId = 2},
                    new {Id = 2, Date = DateTime.ParseExact("11/14/2021", new string[] { "MM.dd.yyyy", "MM-dd-yyyy", "MM/dd/yyyy" }, provider, DateTimeStyles.None), Name = "SOLID", HomeworkId = 2, LectorId = 3}
                });
