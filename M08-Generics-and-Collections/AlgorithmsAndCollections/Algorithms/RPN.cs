...
namespace AlgorithmsAndCollections.Algorithms
{
    public static class RPN
    {
        public static double Calculate(string input)
        {
            string output = GetExpression(input); // Обратная польская запись
                ...
                else if (IsOperator(input[i])) //Если символ - оператор
                {
                    ...
                    switch (input[i]) //И производим над ними действие, согласно оператору
                    {
                        ...
                        case '/': 
                            ...
                            {
                                throw new DivideByZeroException($"Исключение деление на {a}");
                            }
                            result = b / a; 
                            break;
        ...
        /// <returns>Приоритет оператора от 0 до 6</returns>
        ...
        /// <returns>True если "с" - оператор</returns>
        ...
        /// <returns>True если "c" - разделител</returns>
